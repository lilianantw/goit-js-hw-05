// Задача 1. Імена користувачів //метод map()
// Напиши стрелочную функцию getUserNames(users), которая принимает один
...
// Проверка:
// Возьми код ниже и вставь после объявления своей функции для проверки ее
// корректности. В консоль будут выведены результаты ее вызовов.
