// Задача 3. Сортування за кількістю друзів // метод toSorted()
...
//  відсортованих за спаданням кількостій
...
// Змінній sortByDescendingFriendCount присвоєна
//  стрілочна функція з параметром (users)
// Для перебирання параметра users використаний
//  метод toSorted()
// Виклик функції із зазначеним масивом users повертає
//  новий масив користувачів, відсортований
//  за спаданням кількості їхніх друзів
// Виклик функції з випадковими,
//  але валідними аргументами повертає
//  правильне значення
//---------------------------------------------------------
//---------------------------------------------------------
